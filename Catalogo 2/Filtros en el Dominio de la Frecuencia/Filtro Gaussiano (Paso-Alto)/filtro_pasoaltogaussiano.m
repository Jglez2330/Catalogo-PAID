function ejemploFiltroPasoAltoGaussiano
  % Ejemplo
  ...
  filtroPasoAltoGaussiano(80);
  
endfunction

function filtroPasoAltoGaussiano(sigma)
  % Esta funcion aplica el filtro alto bajo gaussiano a una imagen
  % en escala de grises
  % Parametros de entrada: sigma = valor del radio del
  #                        circulo del filtro pasoalto gaussiano
